...
| ID | 합격 | HUMAN |
|---|---|---|
| G1 | `전라도에 사는 남성 고객` → region `IN ('전북','전남')` + gender frag 별도. 칩 1장(전라도) 또는 멤버가 보이게 | **PASS** 2026-08-14 재확인 · **2026-08-21 파도1** `IN ('전남','전북')`∩`M` · 칩 `전라도→전남,전북`+[맞음] · generatePlan pass1(Foundry無) |
