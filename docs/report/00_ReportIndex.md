...
| `upgrade_plan/34_Pass0_슬롯원자분할_170.md` | #170 — Pass0 축1슬롯1 · normalizeAtomicSlots |
| `upgrade_plan/35_Generate_값바인딩_168B.md` | #168-B — plan.params ← param_domain · 템플릿 계약 |
| `upgrade_plan/36_FragContract_공유계약.md` | #172 — Slot↔Index↔Match↔Bind 공유 계약 · testWooFragContract |
